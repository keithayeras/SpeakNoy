...
urlpatterns = [
    ...
    path('<int:pk>/removecollection/', collection_remove_view, name='collectionremove'),
    path('<int:pk>/remove-from-collection/', collection_remove_card, name='remove_from_collection'),
